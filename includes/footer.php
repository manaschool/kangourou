               ...
               <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <div class="bd-footer-widget bd-footer-widget-4">
                        <div class="bd-footer-widget-content">
                           <h4 class="bd-footer-widget-title mb-30">Adresse</h4>
                           <div class="bd-footer-contact">
                              <ul>
                                 <li><i class="fa-light fa-location-dot"></i><a href="#">Rue de la Concorde, Montana*City, Logpom, Douala, Cameroun</a></li>
                                 <li><i class="fa-light fa-phone"></i><a href="tel:9072003462">wa.me/237656097046</a></li>
