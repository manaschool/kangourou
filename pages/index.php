...
<!-- Mirrored from codeskdhaka.com/html/kindedo-prev/kindedo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jun 2024 13:32:22 GMT -->
<head>
   <meta charset="utf-8">
   ...
   <main>
                                 ...
                                 <div class="bd-hero-content-wrapper-2 d-flex align-items-center">
                                    <div class="bd-hero-content bd-hero-content-2 is-white">
                                       <span class="animate__animated" data-animation="fadeInUp"
                                          data-delay=".3s">Bienvenue chez Kangourou</span>
                                       <h1 class="bd-hero-title animate__animated" data-animation="fadeInUp"
                                          data-delay=".5s">
                                          Votre soutien scolaire à domicile
                                       </h1>
                                       <div class="bd-hero-btn animate__animated" data-animation="fadeInUp"
                                          data-delay=".7s">
                                          <a href="programs.html" class="bd-btn">
                                             <span class="bd-btn-inner">
                                                <span class="bd-btn-normal">Rejoignez-nous maintenant</span>
                                                <span class="bd-btn-hover">Rejoignez-nous maintenant</span>
                                             </span>
                                          </a>
                                       </div>
                                    </div>
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="bd-hero-content-wrapper-2 d-flex align-items-center">
                                    <div class="bd-hero-content bd-hero-content-2 is-white">
                                       <span class="animate__animated" data-animation="fadeInUp"
                                          data-delay=".3s">Réussir Ensemble</span>
                                       <h1 class="bd-hero-title animate__animated" data-animation="fadeInUp"
                                          data-delay=".5s">
                                          Suivis personnalisé des enfants 
                                       </h1>
                                       <div class="bd-hero-btn animate__animated" data-animation="fadeInUp"
                                          data-delay=".7s">
                                          <a href="program" class="bd-btn">
                                             <span class="bd-btn-inner">
                                                <span class="bd-btn-normal">Commencez dès maintenant"</span>
                                                <span class="bd-btn-hover">Commencez dès maintenant"  </span>
                                             </span>
                                          </a>
                                       </div>
                                    </div>
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="bd-hero-content-wrapper-2 d-flex align-items-center">
                                    <div class="bd-hero-content bd-hero-content-2 is-white">
                                       <span class="animate__animated" data-animation="fadeInUp"
                                          data-delay=".3s">Kangourou - </span>
                                       <h1 class="bd-hero-title animate__animated" data-animation="fadeInUp"
                                          data-delay=".5s">
                                          Le Savoir à Portée de Main pour Chaque Élève
                                       </h1>
                                       <div class="bd-hero-btn animate__animated" data-animation="fadeInUp"
                                          data-delay=".7s">
                                          <a href="programs.html" class="bd-btn">
                                             <span class="bd-btn-inner">
                                                <span class="bd-btn-normal">Rejoignez-nous</span>
                                                <span class="bd-btn-hover">Rejoignez-nous</span>
                                             </span>
                                          </a>
                                       </div>
                                    </div>
      ...
      <section class="bd-hero-area bd-hero-area-3 fix">
                        ...
                        <div class="bd-hero-thumb-3-wrapper p-relative z-index-1" data-depth=".4">
                           <div class="bd-hero-thumb-3 p-relative">
                              <div class="bd-hero-thumb-3-mask" >
                                 <img src="https://img.freepik.com/free-photo/teacher-helping-kids-class_23-2148892531.jpg?t=st=1720882798~exp=1720886398~hmac=44a34aa4a2002f9ce5dc58e4bab099a0d285477207e42a1436039e79fe46028d&w=826"  alt="img not found!">
                              </div>
                           </div>
         ...
         <div class="bd-hero-3-shape d-none d-lg-block" id="scene2">
            <img data-depth=".5" src="assets/img/shape/hero-3-shape-4.png" alt="img not found!">
         </div>
      </section> */?>
      <!-- hero area end here  -->
                     ...
                     <div class="swiper-wrapper">
                           ...
                           <div class="bd-class-wrapper text-center">
                              ...
                              <div class="bd-class">
                                 <div class="bd-class-icon">
                                    <img src="https://cdn-icons-png.flaticon.com/128/769/769651.png" alt="">
                                    <!-- <i class="flaticon-sports"></i> -->
                                 </div>
                                 <div class="bd-class-content">
                                    <h3 class="bd-class-title"><a href="class-details.html">Primaire (CP à CM2)</a></h3>
                                    <p>Kangourou propose un soutien scolaire pour les élèves du primaire, visant à renforcer les bases en lecture, écriture et calcul.</p>
                        ...
                        <div class="swiper-slide">
                           <div class="bd-class-wrapper text-center">
                              ...
                              <div class="bd-class text-center">
                                 <div class="bd-class-icon">
                                    <img src="https://cdn-icons-png.flaticon.com/128/3429/3429142.png" alt="">
                        ...
                        <div class="swiper-slide">
                           <div class="bd-class-wrapper text-center">
                              ...
                              <div class="bd-class text-center">
                                 <div class="bd-class-icon">
                                    <img src="https://cdn-icons-png.flaticon.com/128/4207/4207247.png" alt="">
                                    <!-- <i class="flaticon-color-palette"></i> -->
                                 </div>
                                 <div class="bd-class-content">
                                    <h3 class="bd-class-title"><a href="class-details.html">2nde à Terminale</a></h3>
                                    <p>Les lycéens bénéficient d'un programme intensif pour préparer le baccalauréat et les examens nationaux avec l'aide de nos professeurs particuliers.</p>
                                    <div class="bd-class-btn">
                                       <a href="class-details.html" class="bd-btn bd-btn-grey">
                                          <span class="bd-btn-inner">
                                             <span class="bd-btn-normal">View Details</span>
                  ...
                  <div class="bd-promotion-thumb-wrapper mb-60 wow fadeInLeft" data-wow-duration="1s"
                     ...
                     <div class="bd-promotion-thumb">
                        <div class="bd-promotion-thumb-mask p-relative wow fadeInLeft" data-wow-duration="1s"
                           data-wow-delay=".3s">
                           <img src="https://img.freepik.com/free-photo/teacher-helping-kids-class_23-2148892532.jpg?t=st=1720892192~exp=1720895792~hmac=8386c5f1d57a098c527a59a328a99babefb491e1fe6c8e6035585808002d2182&w=740" alt="Image not found">
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="bd-promotion mb-60 wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                     ...
                     <div class="bd-promotion-list mb-50">
                        <ul>
                           <li>Nous croyons que chaque enfant est intelligent, c'est pourquoi nous nous en soucions.</li>
                           <li>Les enseignants font la différence pour votre enfant.</li>
                        </ul>
                     </div>
                     <div class="bd-promotion-btn-wrapper flex-wrap">
                        ...
                        <?php /*<div class="bd-promotion-btn-2 bd-pulse-btn btn-2">
                           <a href="https://www.youtube.com/watch?v=l62SIcbCPwo" class="popup-video"><i
                                 class="flaticon-play-button"></i> Vidéo promotionnelle </a>
                        </div> */?>
                     </div>
                  </div>
               </div>
...
<!-- Mirrored from codeskdhaka.com/html/kindedo-prev/kindedo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jun 2024 13:32:50 GMT -->
</html>